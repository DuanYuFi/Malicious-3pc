...
bool verify(
    ...
    // if((party_ID + 1 - prover_ID) % 3 == 0) {
    //     p_eval_r = Mersenne::sub(self_vermsg.final_result_ss, other_vermsg.final_result_ss);
    // }
    // else {
    //     p_eval_r = Mersenne::sub(other_vermsg.final_result_ss, self_vermsg.final_result_ss);
    // }
